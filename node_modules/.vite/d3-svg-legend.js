...
function ticks_default(start, stop, count) {
  ...
  return range_default(Math.ceil(start / step) * step, Math.floor(stop / step) * step + step / 2, step);
}
...
// dep:d3-svg-legend
var d3_svg_legend_default = indexRollupNext_default;
export {
  d3_svg_legend_default as default,
